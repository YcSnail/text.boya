...
<ul>
    <li  class="left_current" ><a href="index.html" onfocus="this.blur();">干细胞知识</a></li>
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;干细胞知识</div>
                        <p>
                    ...
                    <div class="box">
                        <p>
                            <strong class="newsdt_tit">关于干细胞的基础知识</strong>
                        </p>
                        <p>&nbsp;
                            </p>
							...
							<% call question %>
                              ...
                              <p> <div style="float:left;padding-top:6px">分享到:</div><div><!-- baidu button begin -->
