...
<ul>
     <li ><a href="index.html" onfocus="this.blur();">董事长致辞</a></li>
                    ...
                    <li><a href="<%=JumpRel%>about/honor.html" onfocus="this.blur();">企业荣誉</a></li>
										...
										<li class="left_current"><a href="bigthing.html" onfocus="this.blur();">博雅大事记</a></li>
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;博雅大事记</div>
                        <p>
                            您现在的位置：<span><a href="../index.html">首页</a></span> - <span><a href="index.html">关于博雅</a></span>
                            - <span class="lv_tree_current"><a href="#">博雅大事记</a></span></p>
                    <div class="box"><%call information("博雅大事记","","")%></div>
