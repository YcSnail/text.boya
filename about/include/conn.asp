...
<!--#include file="../../inc_nav.asp"-->
        ...
        <div class="lv_content">
            ...
            <div class="lv_banner1"><img src="/about/images/banner.jpg" width="960" height="200" /></div>
...
<ul>
                                      <li ><a href="index.html" onFocus="this.blur();">董事长致辞</a></li>
										<li><a href="Company.html" onFocus="this.blur();">博雅简介</a></li>
										<li ><a href="Better.html" onFocus="this.blur();">四大优势</a></li>
										<li><a href="Culture.html" onFocus="this.blur();">企业文化</a></li>
                    <li><a href="honor.html" onFocus="this.blur();">企业荣誉</a></li>
										<li><a href="Fengcai.html" onFocus="this.blur();">员工风采</a></li>
										<li><a href="Bigthing.html" onFocus="this.blur();">博雅大事记</a></li>
										<li><a href="../activities/NewsDt.html" onFocus="this.blur();">博雅动态</a></li>
											<!--<li><a href="../activities/NewsDt1.html" onFocus="this.blur();">焦点新闻</a></li>-->
	                   <li  class="left_current" ><a href="meiti.html" onFocus="this.blur();">媒体报道</a></li>
										 <li><a href="People.html" onFocus="this.blur();">人才招聘</a></li>
										<li><a href="Contact.html" onFocus="this.blur();">联系我们</a></li>
                                                                            <li><a href="remind.html" onFocus="this.blur();">投资提醒</a></li>
</ul>
<div class="left_img">
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;媒体报道</div>
                        <p>
                            您现在的位置：<span><a href="../index.html">首页</a></span> - <span><a href="index.html">关于博雅</a></span>
                            - <span class="lv_tree_current">媒体报道</span></p>
                    </div>
                    <div class="box">
                    	<!--<iframe src="https://app.meltwater.com/gyda/outputs/5872fdcf4f82639838e8ebc2/rendering?apiKey=577319de5390dfd13894dd8e&type=html"  frameborder="0"  scrolling="No"  vspace="0" marginheight="0"  marginwidth="0" width="100%" height="300"></iframe>-->
                      <br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <%if rs("Picsmall")<>"" then%>
    <td valign="top" width="175"><a href="../meiti/<%=rs("id")%>.html"><img src="<%=JumpRel%><%=rs("Picsmall")%>" width="163" height="104" style="display: block; margin: 0 auto;" /></a></td>
    <%end if%>
    <td valign="top">
       <p><strong><a href="../meiti/<%=rs("id")%>.html"><%=rs("title")%></a></strong></p>
...
<tr><td style="border-bottom:1px solid #FCE9CD" width="72%">
  <span style="float:left"> <a href="../meiti/<%=rs("id")%>.html" onFocus="this.blur();"><em><%=rs("title")%></em></a></span>  
</td>
...
dim arrTitle()
set rs=server.CreateObject("adodb.recordset")
sql="select * from TB_Article where ID>0 and classid= "
...
dim arrTitle()
set rs=server.CreateObject("adodb.recordset")
sql="select * from TB_Article where ID>0 and classid=84350157280123433"
'if request("classid")<>"" then sql=sql&"and classid="&request("classid")&" "
sql=sql&"order by "&NewsPxMethod
rs.open sql,conn,1,1
for i=1 to rs.recordcount
...
rs.update
strTemp="<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'>"
strTemp=strTemp&"<tr><td height='30' align='center'><H1><strong style='font-size:14px; color:#ff6600'>"&rs("Title")&"</strong></H1></td></tr>"
strTemp=strTemp&"<tr><td height='30' align='center'>来源："&rs("author")&""&AddDate_lang&rs("Addtime")&Hits_lang&rs("Hits")&"</td></tr>"
strTemp=strTemp&"<tr><td style='border-top:1px dashed #cccccc; padding:10px'>"
strContent=replace(rs("Content"),"uploadfiles/",JumpRel&"uploadfiles/")
strContent=replace(strContent,"ImgUpload/",JumpRel&"ImgUpload/")
...
strTemp=strTemp&"</td></tr><tr><td align='center' height='80'><a href='javascript :;' onClick='javascript :history.back(-1);'><input type='button' style='background:url(../../images/else/btn_bg.jpg);width:43px; height:19px; border:0; color:#ffffff' value='返回' onclick='javascript:void(0);'></a></td></tr><tr><td height='30'>"
for o=0 to ubound(arrLink)
  if arrLink(o)=rs("id") then
	  if o>0 then
...
<ul>
                    <li ><a href="../about/index.html" onFocus="this.blur();">董事长致辞</a></li>
										...
										<li ><a href="../about/Better.html" onFocus="this.blur();">四大优势</a></li>
										<li><a href="../about/Culture.html" onFocus="this.blur();">企业文化</a></li>
                    <li><a href="../about/honor.html" onFocus="this.blur();">企业荣誉</a></li>
										<li><a href="../about/Fengcai.html" onFocus="this.blur();">员工风采</a></li>
										<li><a href="../about/Bigthing.html" onFocus="this.blur();">博雅大事记</a></li>
										<li><a href="../activities/NewsDt.html" onFocus="this.blur();">博雅动态</a></li>
											<!--<li><a href="../activities/NewsDt1.html" onFocus="this.blur();">焦点新闻</a></li>-->
	                   <li  class="left_current" ><a href="../about/meiti.html" onFocus="this.blur();">媒体报道</a></li>
