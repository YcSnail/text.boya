...
<ul>
    <li  class="left_current" ><a href="index.html" onfocus="this.blur();">干细胞简历</a></li>
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;干细胞简历</div>
                        <p>
                            您现在的位置：<span><a href="../index.html">首页</a></span> - <span><a href="index.html">为何存储干细胞</a></span>
                            - <span class="lv_tree_current"><a href="#">干细胞简历</a></span></p>
                    </div>
                    <div class="box">
                        <p align="center">
                            
                            <img src="../images/else/xbjl_img.jpg" border="0" usemap="#map" />
                            <map name="map" id="map">
                              
                              <area shape="rect" coords="19,837,326,953" href="research.html" />
                              <area shape="rect" coords="366,838,686,954" href="../member/default.html" />
                            </map>
                        </p>
                    </div>
                </div>
