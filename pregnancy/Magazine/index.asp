...
rs.open "select * from Magazine where id="&clng(request("id"))&"",conn,1,1
'response.Write("select * from Magazine where id="&clng(request("id"))&"")

title=rs("title")

set rss=server.CreateObject("adodb.recordset")
rss.open "select * from NImage where parentid="&clng(request("id"))&" order by px asc,id desc",conn,1,1
'	response.Write("select * from NImage where parentid="&clng(request("id"))&" order by px asc,id desc")
XMLFILE="xml/Pages.xml"
dim writeContent
writeContent="<content width=""710"" height=""969"" bgcolor=""cccccc"" loadercolor=""ffffff"" panelcolor=""DC851F"" buttoncolor=""DC851F"" textcolor=""ffffff"">"&chr(10)
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="100%" height="100%">
  <param name="movie" value="swf/Magazine.swf?rand=<%=num%>" />
  <param name="quality" value="high" />
  <param name="bgcolor" value="#cccccc" />
  <param name="allowFullScreen" value="true" />
  <param name="allowScriptAccess" value="sameDomain" />
  <embed src="swf/Magazine.swf?rand=<%=num%>" width="100%" height="100%" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allowFullScreen="true" allowScriptAccess="sameDomain"></embed>
</object>
