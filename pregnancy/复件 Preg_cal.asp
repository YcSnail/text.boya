                ...
                <div class="dateset">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <input name="set_year" class="set_year" id="set_year" maxlength="4" value="<%=year(now)%>" onclick="showsetdiv('set_year_div')" />
                        ...
                        <div style="position:relative; float:left">
                        <input name="set_month" class="set_month" id="set_month" maxlength="2" value="<%=month(now)%>" onclick="showsetdiv('set_month_div')"/>
                        ...
                        <td width="55"> 
                        <div style="position:relative; float:left">
                        <input name="set_day" class="set_day" id="set_day" maxlength="2" value="<%=day(now)%>"  onclick="showsetdiv('set_day_div')" />
                        ...
                        <td>
                        <div style="position:relative; float:left">
                        <input name="set_cycle" class="set_cycle" id="set_cycle" maxlength="2" value="28"  onclick="showsetdiv('set_cycle_div')" />
                        ...
                        <td><img src="images/btn.gif" style="cursor:pointer" onclick="return datejudgment()" align="absmiddle" alt="点击开始计算"></td>
                      </tr>
                    </table>
                   ...
                   <br><br>
                   <div id="soucs" style="display:none">
                    您现在是孕<span id="weeks"></span>周
                    <br>
                    宝宝将于
