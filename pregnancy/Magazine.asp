...
<ul>
    ...
    <li class="left_current"><a href="magazine.html" onfocus="this.blur();">你好宝贝</a></li>
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;你好宝贝</div>
                        <p>
                            您现在的位置：<span><a href="../index.html">首页</a></span> - <span><a href="index.html">孕育家园</a></span>
                            - <span class="lv_tree_current"><a href="#">你好宝贝</a></span></p>
                    </div>
                    <div class="box">
<img src="tu1/nhbb.jpg" width="707" height="84"/>
                        <%call magazine%>
