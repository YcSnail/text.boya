...
<head>
<title>博雅动态_博雅干细胞（BOYALIFE）</title>
...
<!--#include file="../../inc_nav.asp"-->
        ...
        <div class="lv_content"><div class="lv_banner1"><img src="/activities/images/banner1.jpg" width="960" height="200" /></div>
...
<ul>
    ...
    <li ><a href="../about/index.html" onFocus="this.blur();">董事长致辞</a></li>
    <li><a href="../about/Company.html" onFocus="this.blur();">博雅简介</a></li>
		<li ><a href="Better.html" onFocus="this.blur();">四大优势</a></li>
    <li><a href="../about/Culture.html" onFocus="this.blur();">企业文化</a></li>
										<li><a href="../about/publicgood.html" onFocus="this.blur();">博雅公益</a></li>
    <li><a href="<%=JumpRel%>about/honor.html" onFocus="this.blur();">企业荣誉</a></li>
    <li><a href="../about/fengcai.html" onFocus="this.blur();">员工风采</a></li>
    <li><a href="../about/Bigthing.html" onFocus="this.blur();">博雅大事记</a></li>
    <li  class="left_current" ><a href="NewsDt.html" onFocus="this.blur();">博雅动态</a></li>
 <!--<li><a href="NewsDt1.html" onFocus="this.blur();">焦点新闻</a></li>-->
    <li><a href="<%=JumpRel%>about/meiti.html" onFocus="this.blur();">媒体报道</a></li>
    <li><a href="../about/People.html" onFocus="this.blur();">人才招聘</a></li>
    <li><a href="../about/Contact.html" onFocus="this.blur();">联系我们</a></li>
    <li><a href="../about/remind.html" onFocus="this.blur();">投资提醒</a></li>   
    </ul>
<div class="left_img">
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;博雅动态</div>
                        <p>
                            您现在的位置：<span><a href="../index.html">首页</a></span> - <span><a href="../about/index.html">关于博雅</a></span>
                            - <span class="lv_tree_current">博雅动态</span></p>
                    </div>
                    <div class="box">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <%if rs("Picsmall")<>"" then%>
    <td valign="top" width="175"><a href="../newsdt/<%=rs("id")%>.html"><img src="<%=JumpRel%><%=rs("Picsmall")%>" width="163" height="104"  /></a></td>
    <%end if%>
    <td valign="top">
       <p><strong><a href="../newsdt/<%=rs("id")%>.html"><%=rs("title")%></a></strong></p>
       <p><%=year(rs("AddTime"))%>-<%=month(rs("AddTime"))%>-<%=day(rs("AddTime"))%></p>
       <p><%=gotTopic(RemoveHTML(rs("content")),100)%></p>
    </td>
  </tr>
</table>
...
<td height="30" style="border-bottom:1px solid #FCE9CD">
  <span style="float:left"> 
  	<a href="../newsdt/<%=rs("id")%>.html" onFocus="this.blur();"><em><%=rs("title")%></em></a></span> 
...
dim arrTitle()
set rs=server.CreateObject("adodb.recordset")
sql="select * from TB_Article where ID>0  and classid=72621643502977024"
...
for o=0 to ubound(arrLink)
  if arrLink(o)=rs("id") then
	  if o>0 then
		strTemp=strTemp&"<a href='./"&arrLink(o-1)&".html'>"&prevLink_lang&"："&arrTitle(o-1)&"</a>"
	  end if
	  strTemp=strTemp&"<br>"
	  if o<ubound(arrLink) then
		strTemp=strTemp&"<a href='./"&arrLink(o+1)&".html'>"&nextLink_lang&"："&arrTitle(o+1)&"</a>"
	  end if
  end if
next
...
<meta name="Description" content="<%=rs("hdescription")%>" /></head>
<body>
...
<ul>
    ...
    <li><a href="../about/fengcai.html" onFocus="this.blur();">员工风采</a></li>
    <li><a href="../about/Bigthing.html" onFocus="this.blur();">博雅大事记</a></li>
    <li  class="left_current" ><a href="../activities/NewsDt.html" onFocus="this.blur();">博雅动态</a></li>
 <!--<li><a href="NewsDt1.html" onFocus="this.blur();">焦点新闻</a></li>-->
    <li><a href="<%=JumpRel%>about/meiti.html" onFocus="this.blur();">媒体报道</a></li>
    <li><a href="../about/People.html" onFocus="this.blur();">人才招聘</a></li>
    <li><a href="../about/Contact.html" onFocus="this.blur();">联系我们</a></li>
...
<td height="30" style="border-bottom:1px solid #FCE9CD">
  <span style="float:left"> 
  	<a href="../newszx/<%=rs("id")%>.html" onFocus="this.blur();"><em><%=rs("title")%></em></a></span> 
  <span style="float:right"> <%=year(rs("AddTime"))%>-<%=month(rs("AddTime"))%>-<%=day(rs("AddTime"))%></span>
</td>
</tr>
<%
...
dim arrTitle()
set rs=server.CreateObject("adodb.recordset")
sql="select * from TB_Article where ID>0 and classid=52563151555331835 "
'if request("classid")<>"" then sql=sql&"and classid="&request("classid")&" "
sql=sql&"order by "&NewsPxMethod
'response.write(sql)
rs.open sql,conn,1,1
...
<ul>
    ...
    <li class="left_current"><a href="../activities/NewsZx.html" onFocus="this.blur();">行业资讯</a></li>
...
<td height="30" style="border-bottom:1px solid #FCE9CD">
  <span style="float:left"> 
  	<a href="?id=<%=rs("id")%>" onFocus="this.blur();"><em><%=rs("title")%></em></a></span> 
  <span style="float:right"> <%=year(rs("AddTime"))%>-<%=month(rs("AddTime"))%>-<%=day(rs("AddTime"))%></span>
</td>
</tr>
<%
...
<title>BOYALIFE博雅干细胞科技有限公司（博雅干细胞库）</title>
<link href="../css/common.css" rel="stylesheet" type="text/css" />
<link href="../css/else.css" rel="stylesheet" type="text/css" />
    ...
    <![endif]-->
<meta name="Keywords" content="博雅干细胞库,符合国际标准的高端干细胞库,国际干细胞联合研究中心,无锡国际干细胞联合研究中心" />
<meta name="Description" content="博雅干细胞库2009年成立于无锡，博雅干细胞库是由博雅干细胞科技有限公司整体运营的，由来自全球知名的干细胞存储、研究团队组建，中国内地首家也是唯一一家按照国际AABB（美国血库协会）标准设计和建立的干细胞库，代表着目前该领域国际最领先的技术水平。" />
</head>
<body>
...
<ul>
    <li><a href="../member/index.html" onFocus="this.blur();">会员信息</a></li>
    <li><a href="../member/Modify.html" onFocus="this.blur();">修改资料</a></li>

    <li><a href="../member/AskFor.html" onFocus="this.blur();">索取资料</a></li>   <!--<li><a href="Notice.html" onFocus="this.blur();">信息公告</a></li>-->
    <li><a href="../member/Down.html" onFocus="this.blur();">资料下载</a></li>
    <li><a href="../member/OrderList.html" onFocus="this.blur();">订单查询</a></li>
    <li><a href="CTR.html" onFocus="this.blur();">保险查询</a></li>
    <li  class="left_current"><a href="Tidbits.html" onFocus="this.blur();">活动花絮</a></li>
<li><a href="../member/Mother.html" onFocus="this.blur();">博雅妈咪分享</a></li><!--
<li><a href="../member/Health.html" onFocus="this.blur();">医学咨询</a></li>-->
<li><a href="../member/Message.html" onFocus="this.blur();">在线留言</a></li>
<li><a href="../pregnancy/index.html" onFocus="this.blur();">孕育家园</a></li><!--
    <li  ><a href="AppReg.html" onFocus="this.blur();">App注册</a></li>-->
...
<!--#include file="../../inc_leftLastNews.asp"-->
                ...
                <div class="rignt_con">
                    <div class="lv_tree">
                        <div class="lv_tree_tit">
                            <img src="../images/default/ico01.jpg" align="absmiddle" />&nbsp;&nbsp;活动花絮</div>
                        <p>
                            您现在的位置：<span><a href="../index.html">首页</a></span> - <span><a href="Action.html">资料库</a></span>
                            - <span class="lv_tree_current">活动花絮</span></p>
                    </div>
                    <div class="box">
...
%>
 <ul>
	<li class="img_bg">
		<a href="?id=<%=rs("id")%>"><img src="<%=JumpRel%><%=rs("picsmall")%>" width="131" height="84" style="display: block" border="0" /></a></li>
	<li class="img_con">
		<p><strong><a href="?id=<%=rs("id")%>"><%=rs("title")%></a></strong></p>
		<p><%=gotTopic(removehtml(rs("content")),260)%>&nbsp;&nbsp;<a href="?id=<%=rs("id")%>" style='color:#ff6600'>[点击查看]</a></p>
	</li>
</ul>
<%
